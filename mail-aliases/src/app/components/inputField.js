...
export function RandomizerButton() {
  function randomizer() {
    const createInputField = document.getElementsByName('create')[0];
  ...
  return (
    <Button variant='outline-secondary' id='randomizer' onClick={randomizer}>
...
function generateRandomString(string_length = 4) {
