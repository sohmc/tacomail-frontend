...
export function GetIcons({ ignoreFlag, activeFlag, newFlag }) {
  ...
  if (newFlag) {
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-stars ms-1 text-warning" viewBox="0 0 16 16" title="Alias is new!">
    ...
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-envelope-x-fill ms-1 text-danger" viewBox="0 0 16 16" title="Alias is inactive">
    ...
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-incognito ms-1" viewBox="0 0 16 16" title="Alias is being ignored">
