...
export function GetIcons({ ignoreFlag, activeFlag, newFlag }) {
  ...
  if (newFlag) {
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-stars" viewBox="0 0 16 16" className='ms-1'>
    ...
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-x-fill" viewBox="0 0 16 16" className='ms-1'>
    ...
    icon = (
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-incognito" viewBox="0 0 16 16" title="Alias is being ignored" className='ms-1'>
